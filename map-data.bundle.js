  ...
  "north-xinjiang": {
    "points": [
      ...
      },
      {
        ...
        "lng": 87.03,
        "img": "kanas_lake.jpg",
        "desc": "冰碛堰塞湖与三湾栈道:奶蓝色河水拐过云杉林;次日清晨上观鱼台俯瞰整面变色湖。",
        "tags": [
          "森林",
          "湖泊",
          "徒步"
      ...
      },
      {
        ...
        "desc": "图瓦人原木村落,全程最值得花钱的一晚:傍晚观景台看炊烟日落,清晨看晨雾漫过河谷。",
        "tags": [
          "村庄",
          "徒步",
          "晨雾"
...
`,
  "north-xinjiang": `# 北疆 · 喀纳斯与戈壁的初秋大环线｜7 天自驾执行手册
...
## 为什么值得为可可托海绕这一程？
很多 7 天行程会砍掉可可托海直奔喀纳斯。我们保留它，理由有二：一是**神钟山峡谷**的花岗岩地貌在整个北疆独一份（D3 上午见）；二是它把 940 km 的"乌鲁木齐→布尔津"拆成两天，每天都在 6 小时以内——**不砍景点，砍疲劳**。
...
### 下午：三湾栈道徒步（顺光时段）
区间车沿喀纳斯河上行，依次经过**卧龙湾、月亮湾、神仙湾**三个站。正确玩法是：坐到卧龙湾下车，**沿河边栈道向上游步行串起三湾**（全程约 6 km，2.5～3 小时，平缓木栈道）。下午阳光正好打在河面上，湖水呈现那种被反复拍进纪录片的**奶蓝色**（冰川岩粉悬浮散射所致），云杉林一路遮阴。
